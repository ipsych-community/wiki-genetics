...
To preview your page locally in RStudio, you can use `Ctrl + Shift + K` (like with any Rmd). 
To build the entire book, which is useful to e.g. rebuild the table of content (ToC), you can use `Ctrl + Shift + B`. 
